...
plotTsne(tsne, cpm.log2(counts.cpm))
```
<br></br>
...
```{r, fig.align="center", fig.width=6, fig.height=6}
plotTsne(tsne, cpm.log2(counts.cpm), "CD74")
```
<br></br>
...
```{r, fig.align="center", fig.width=6, fig.height=6}
plotTsne(tsne, cpm.log2(counts.cpm), c("CD74", "ANXA3", "ACTG2"))
```
<br></br>
...
```{r}
p <- plotTsne(tsne, cpm.log2(counts.cpm), c("CD74", "ANXA3", "ACTG2"))
plotData(p)
```
